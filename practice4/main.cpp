...
void publish_message(MQTT::Client<MQTTNetwork, Countdown>* client_out) {
   while(1){
...
///////////////////////////////////////////////////////////////
    ...
    remote_thread.start(callback(&remote_queue, &EventQueue::dispatch_forever));

    btn2.rise(remote_queue.event(&remote));
